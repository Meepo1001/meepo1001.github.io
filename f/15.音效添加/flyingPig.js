...
function init()
{
	...
	winMusic = loadAudio("music/win.mp3");
	loseMusic1 = loadAudio("music/gameOver1.wav");
	loseMusic2 = loadAudio("music/gameOver2.mp3");
	explosionMusic = loadAudio("music/explosion.mp3");
	shootMusic = loadAudio("music/shoot.mp3");
	runeMusic = loadAudio("music/rune.m4a");
	animation2Music = loadAudio("music/animation2.m4a");
	animation1Music = loadAudio("music/animation1.m4a");
	animation0Music = loadAudio("music/animation0.m4a");
...
function gameLoop()
{
	if(page == 0 )animation0();
	else if(page == 1)animation1();
	else if(page == 2)animation2();
	else if(page > 2)
	{
		// console.log(time);
		if(gameOver == false)
		{
			animation2Music.pause();
			bgMusic.play();
			time ++; 
			clearScreen();
			drawGround();
...
function animation2()
{
	context.drawImage(bg1, 0, 0, cw, ch);
	var princess = addImg("animation/princess.png");
	context.drawImage(princess, 0, 200);
	var text = addImg("animation/text.png");
	context.drawImage(text, 0, 500, cw, 300);
	context.font = "40px 微软雅黑";
	context.fillStyle = "white";
	context.fillText("快来啊，我好怕...", 100, 580);

	animation1Music.pause();
	animation2Music.play();
}
...
function animation1()
{
	clearScreen();
	context.drawImage(bg1, 0, 0, cw, ch);
	var fp = addImg("animation/flyingPig.png");
	context.drawImage(fp, 500, 300);
	var text = addImg("animation/text.png");
	context.drawImage(text, 0, 500, cw, 300);
	context.font = "40px 微软雅黑";
	context.fillStyle = "white";
	context.fillText("别担心，我会来救你的！", 100, 580);

	animation0Music.pause();
	animation1Music.play();
}
...
function animation0()
{
	clearScreen();
	context.drawImage(bg1, 0, 0, cw, ch);
	var boss = addImg("animation/boss.png");
	context.drawImage(boss, 200, 100);
	var text = addImg("animation/text.png");
	context.drawImage(text, 0, 500, cw, 300);

	context.font = "40px 微软雅黑";
	context.fillStyle = "white";
	context.fillText("美丽的公主，我要抓走你，哈哈！", 100, 580);

	animation0Music.play();
}
